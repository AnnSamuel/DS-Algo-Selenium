...
public class DsAlgo_ArrayQuestionPage {
	WebDriver driver;
...
//    By applicationsOfArray = By.linkText("Applications of Array");
    ...
    public DsAlgo_ArrayQuestionPage(WebDriver driver) {
    	this.driver=driver;
    	 }
...
//    }
   ...
   public void clearExistingText(){
      //driver.findElement(textEditor).clear();
	   driver.findElement(textEditor).sendKeys(Keys.chord(Keys.CONTROL,"a",Keys.DELETE));
